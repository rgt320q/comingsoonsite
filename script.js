...
const translations = {
    tr: {
        page_title: "mrCetin Software - Mobil Uygulama ve Oyun Tasarımı",
        ...
        game_project_1_description: "Heyecan verici bir macera oyunu. Geliştirme aşamasında.",
        game_project_2_title: "Oyun Projesi 2",
        game_project_2_description: "Strateji ve bulmaca öğelerini birleştiren yenilikçi bir oyun. Geliştirme aşamasında.",
        mobile_app_project_title: "Mobil Uygulama Projesi",
        mobile_app_project_description: "Kullanıcı deneyimini ön planda tutan, günlük hayatı kolaylaştıran bir mobil uygulama. Yakında kullanıma sunulacaktır.",
    ...
    en: {
        ...
        game_project_1_description: "An exciting adventure game. Currently in development.",
        game_project_2_title: "Game Project 2",
        game_project_2_description: "An innovative game combining strategy and puzzle elements. Currently in development.",
        mobile_app_project_title: "Mobile App Project",
        mobile_app_project_description: "A mobile application that prioritizes user experience and simplifies daily life. Coming soon.",
    ...
    de: {
        ...
        game_project_1_description: "Ein aufregendes Abenteuerspiel. Derzeit in Entwicklung.",
        game_project_2_title: "Spielprojekt 2",
        game_project_2_description: "Ein innovatives Spiel, das Strategie- und Puzzle-Elemente kombiniert. Derzeit in Entwicklung.",
        mobile_app_project_title: "Mobile App Projekt",
        mobile_app_project_description: "Eine mobile Anwendung, die das Benutzererlebnis in den Vordergrund stellt und den Alltag vereinfacht. Bald verfügbar.",
    ...
    es: {
        ...
        game_project_1_description: "Un emocionante juego de aventuras. Actualmente en desarrollo.",
        game_project_2_title: "Proyecto de Juego 2",
        game_project_2_description: "Un juego innovador que combina elementos de estrategia y rompecabezas. Actualmente en desarrollo.",
        mobile_app_project_title: "Proyecto de Aplicación Móvil",
        mobile_app_project_description: "Una aplicación móvil que prioriza la experiencia del usuario y simplifica la vida diaria. Próximamente.",
    ...
    ru: {
        ...
        game_project_1_description: "Увлекательная приключенческая игра. В настоящее время в разработке.",
        game_project_2_title: "Игровой Проект 2",
        game_project_2_description: "Инновационная игра, сочетающая элементы стратегии и головоломки. В настоящее время в разработке.",
        mobile_app_project_title: "Проект Мобильного Приложения",
        mobile_app_project_description: "Мобильное приложение, которое ставит во главу угла пользовательский опыт и упрощает повседневную жизнь. Скоро будет доступно.",
    ...
    ja: {
        ...
        game_project_1_description: "エキサイティングなアドベンチャーゲーム。現在開発中。",
        game_project_2_title: "ゲームプロジェクト2",
        game_project_2_description: "戦略とパズル要素を組み合わせた革新的なゲーム。現在開発中。",
        mobile_app_project_title: "モバイルアプリプロジェクト",
        mobile_app_project_description: "ユーザーエクスペリエンスを最優先し、日常生活を簡素化するモバイルアプリケーション。近日公開予定。",
        ...
        terms_of_use_text: "mrCetin Softwareのウェブサイトを利用することにより、以下の利用規約に同意するものとします。これらの規約には、当社のウェブサイトの利用、そのコンテンツ、知的財産権、および責任の制限に関する規定が含まれます。当社のウェブサイトのコンテンツは一般的な情報提供のみを目的としており、法的助言を構成するものではありません。お客様は、当社のサービスを悪用したり、違法行為に従事したり、他のユーザーの権利を尊重したりしないことが期待されます。これらの規約に違反した場合、当社のサービスへのアクセスが制限または終了される場合があります。これらの規約を注意深くお読みください。",
        legal_notice_title: "法的情報",
        legal_notice_text: "この法的通知には、mrCetin Softwareの法的情報、会社詳細、および著作権表示が含まれています。当社のウェブサイト上のすべてのコンテンツ、テキスト、グラフィック、ロゴ、およびソフトウェアは、mrCetin Softwareが所有またはライセンスを受けており、著作権法によって保護されています。無断での複製、配布、または使用は禁止されています。当社のウェブサイトの情報は誠意を持って提供されていますが、その正確性または完全性については保証されません。法的な質問や懸念がある場合は、資格のある法律顧問にご相談ください。",
        sitemap_title: "サイトマップ",
        sitemap_text: "mrCetin Softwareウェブサイトのすべてのページにすばやくアクセスするためのサイトマップ。ホーム、私たちのアプリ、会社概要、ビジョン、ミッション、お問い合わせ、プライバシーポリシー、クッキーの使用、利用規約、法的情報などの主要セクションが含まれています。このマップは、ウェブサイトのナビゲーションを容易にし、探している情報にすばやくアクセスできるように設計されています。ページリンクが機能しない場合は、お問い合わせください。"
    },
    zh: {
        page_title: "mrCetin Software - 移动应用与游戏设计",
        ...
        game_project_1_description: "一个激动人心的冒险游戏。目前正在开发中。",
        game_project_2_title: "游戏项目2",
        game_project_2_description: "一款结合了策略和解谜元素的创新游戏。目前正在开发中。",
        mobile_app_project_title: "移动应用项目",
        mobile_app_project_description: "一款优先考虑用户体验并简化日常生活的移动应用程序。即将推出。",
        ...
        footer_legal: "法律声明",
        footer_sitemap: "网站地图",
        footer_copyright: "© 2025 mrCetin Software。保留所有权利。",
        privacy_policy_title: "隐私政策",
        privacy_policy_text: "本隐私政策解释了mrCetin Software如何收集、使用、披露和保护您的个人数据。使用我们的服务即表示您同意本政策中描述的做法。您的数据安全对我们很重要，我们采取一切必要措施保护您的数据。我们收集的数据用于改进我们的服务，为您提供更好的体验，并履行我们的法律义务。未经您的同意，我们不会与第三方共享您的数据，但法律要求或与我们的服务提供商合作的情况可能构成例外。有关您的隐私权的更多信息，请联系我们。",
        ...
        terms_of_use_text: "使用mrCetin Software网站即表示您同意以下使用条款。这些条款包括有关我们网站的使用、其内容、知识产权和责任限制的规定。我们网站上的内容仅供一般信息参考，不构成法律建议。您应避免滥用我们的服务、从事非法活动并尊重其他用户的权利。如果违反这些条款，您对我们服务的访问可能会受到限制或终止。请仔细阅读这些条款。",
        legal_notice_title: "法律声明",
        legal_notice_text: "本法律声明包含mrCetin Software的法律信息、公司详情和版权声明。我们网站上的所有内容、文本、图形、徽标和软件均由mrCetin Software拥有或授权，并受版权法保护。未经授权的复制、分发或使用是禁止的。我们网站上的信息是善意提供的，但不保证其准确性或完整性。如果您有任何法律问题或疑虑，请咨询合格的法律顾问。",
        sitemap_title: "网站地图",
        sitemap_text: "mrCetin Software网站所有页面的快速访问网站地图。包括主页、我们的应用、关于我们、愿景、使命、联系我们、隐私政策、Cookie使用、使用条款、法律声明等主要部分。此地图旨在方便您在我们网站上的导航，并帮助您更快地找到所需信息。如果任何页面链接无法正常工作，请联系我们。"
    },
    ko: {
        page_title: "mrCetin Software - 모바일 앱 & 게임 디자인",
        ...
        game_project_1_description: "흥미진진한 어드벤처 게임. 현재 개발 중.",
        game_project_2_title: "게임 프로젝트 2",
        game_project_2_description: "전략과 퍼즐 요소를 결합한 혁신적인 게임. 현재 개발 중.",
        mobile_app_project_title: "모바일 앱 프로젝트",
        mobile_app_project_description: "사용자 경험을 최우선으로 생각하고 일상 생활을 단순화하는 모바일 애플리케이션. 곧 출시 예정.",
        ...
        footer_legal: "법적 고지",
        footer_sitemap: "사이트맵",
        footer_copyright: "© 2025 mrCetin Software. 모든 권리 보유.",
        privacy_policy_title: "개인정보처리방침",
        privacy_policy_text: "본 개인정보처리방침은 mrCetin Software가 귀하의 개인 데이터를 수집, 사용, 공개 및 보호하는 방법을 설명합니다. 당사 서비스를 이용함으로써 귀하는 본 정책에 설명된 관행에 동의하는 것입니다. 귀하의 데이터 보안은 당사에 중요하며, 당사는 귀하의 데이터를 보호하기 위해 필요한 모든 조치를 취합니다. 당사가 수집하는 데이터는 서비스 개선, 더 나은 경험 제공 및 법적 의무 이행을 위해 사용됩니다. 당사는 귀하의 동의 없이 제3자와 귀하의 데이터를 공유하지 않지만, 법적 요구 사항 또는 서비스 제공업체와의 협력은 예외가 될 수 있습니다. 귀하의 개인정보 보호 권리에 대한 자세한 내용은 당사에 문의하십시오.",
        ...
        terms_of_use_text: "mrCetin Software 웹사이트를 이용함으로써 귀하는 다음 이용 약관에 동의하는 것입니다. 이 약관에는 당사 웹사이트의 이용, 콘텐츠, 지적 재산권 및 책임 제한에 관한 조항이 포함됩니다. 당사 웹사이트의 콘텐츠는 일반적인 정보 제공 목적으로만 제공되며 법적 조언을 구성하지 않습니다. 귀하는 당사 서비스를 오용하거나 불법 활동에 참여하거나 다른 사용자의 권리를 존중하지 않을 것으로 예상됩니다. 이 약관을 위반하는 경우 당사 서비스에 대한 귀하의 접근이 제한되거나 종료될 수 있습니다. 이 약관을 주의 깊게 읽으십시오.",
        legal_notice_title: "법적 고지",
        legal_notice_text: "본 법적 고지에는 mrCetin Software의 법적 정보, 회사 세부 정보 및 저작권 진술이 포함되어 있습니다. 당사 웹사이트의 모든 콘텐츠, 텍스트, 그래픽, 로고 및 소프트웨어는 mrCetin Software가 소유하거나 라이선스를 받았으며 저작권법에 의해 보호됩니다. 무단 복제, 배포 또는 사용은 금지됩니다. 당사 웹사이트의 정보는 선의로 제공되지만, 정확성 또는 완전성에 대한 보증은 제공되지 않습니다. 법적 질문이나 우려 사항이 있는 경우 자격을 갖춘 법률 고문에게 문의하십시오.",
        sitemap_title: "사이트맵",
        sitemap_text: "mrCetin Software 웹사이트의 모든 페이지에 빠르게 액세스하기 위한 사이트맵입니다. 홈, 우리의 앱, 회사 소개, 비전, 미션, 문의, 개인정보처리방침, 쿠키 사용, 이용 약관, 법적 고지 등 주요 섹션이 포함됩니다. 이 지도는 웹사이트 탐색을 용이하게 하고 원하는 정보를 더 빨리 찾을 수 있도록 설계되었습니다. 페이지 링크가 작동하지 않는 경우 당사에 문의하십시오."
    },
    ar: {
        page_title: "mrCetin Software - تصميم تطبيقات الجوال والألعاب",
        ...
        game_project_1_description: "لعبة مغامرات مثيرة. قيد التطوير حاليًا.",
        game_project_2_title: "مشروع اللعبة 2",
        game_project_2_description: "لعبة مبتكرة تجمع بين عناصر الإستراتيجية والألغاز. قيد التطوير حاليًا.",
        mobile_app_project_title: "مشروع تطبيق جوال",
        mobile_app_project_description: "تطبيق جوال يركز على تجربة المستخدم ويبسط الحياة اليومية. قريبا.",
        status_in_development: "قيد التطوير",
        ...
        footer_copyright: "© 2025 mrCetin Software. جميع الحقوق محفوظة.",
        privacy_policy_title: "سياسة الخصوصية",
        privacy_policy_text: "توضح سياسة الخصوصية هذه كيفية قيام mrCetin Software بجمع بياناتك الشخصية واستخدامها والكشف عنها وحمايتها. باستخدام خدماتنا، فإنك توافق على الممارسات الموضحة في هذه السياسة. أمان بياناتك مهم بالنسبة لنا، ونتخذ جميع الإجراءات اللازمة لحماية بياناتك. تُستخدم البيانات التي نجمعها لتحسين خدماتنا، وتزويدك بتجربة أفضل، والوفاء بالتزاماتنا القانونية. لا نشارك بياناتك مع أطراف ثالثة دون موافقتك، ولكن المتطلبات القانونية أو التعاون مع مزودي الخدمة لدينا قد يشكل استثناءً. لمزيد من المعلومات حول حقوق الخصوصية الخاصة بك، يرجى الاتصال بنا.",
