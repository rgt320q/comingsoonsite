...
const translations = {
    ...
    ja: {
        ...
        terms_of_use_text: "mrCetin Tech.のウェブサイトを利用することにより、以下の利用規約に同意するものとします。これらの規約には、当社のウェブサイトの利用、そのコンテンツ、知的財産権、および責任の制限に関する規定が含まれます。当社のウェブサイトのコンテンツは一般的な情報提供のみを目的としており、法的助言を構成するものではありません。お客様は、当社のサービスを悪用したり、違法行為に従事したり、他のユーザーの権利を尊重したりしないことが期待されます。これらの規約に違反した場合、当社のサービスへのアクセスが制限または終了される場合があります。これらの規約を注意深くお読みください。",
        legal_notice_title: "法的情報",
        legal_notice_text: "この法的通知には、mrCetin Tech.の法的情報、会社詳細、および著作権表示が含まれています。当社のウェブサイト上のすべてのコンテンツ、テキスト、グラフィック、ロゴ、およびソフトウェアは、mrCetin Tech.が所有またはライセンスを受けており、著作権法によって保護されています。無断での複製、配布、または使用は禁止されています。当社のウェブサイトの情報は誠意を持って提供されていますが、その正確性または完全性については保証されません。法的な質問や懸念がある場合は、資格のある法律顧問にご相談ください。",
        sitemap_title: "サイトマップ",
        sitemap_text: "mrCetin Tech.ウェブサイトのすべてのページにすばやくアクセスするためのサイトマップ。ホーム、私たちのアプリ、会社概要、ビジョン、ミッション、お問い合わせ、プライバシーポリシー、クッキーの使用、利用規約、法的情報などの主要セクションが含まれています。このマップは、ウェブサイトのナビゲーションを容易にし、探している情報にすばやくアクセスできるように設計されています。ページリンクが機能しない場合は、お問い合わせください。"
    },
    zh: {
        ...
        privacy_policy_text: "本隐私政策解释了mrCetin Tech.如何收集、使用、披露和保护您的个人数据。使用我们的服务即表示您同意本政策中描述的做法。您的数据安全对我们很重要，我们采取一切必要措施保护您的数据。我们收集的数据用于改进我们的服务，为您提供更好的体验，并履行我们的法律义务。未经您的同意，我们不会与第三方共享您的数据，但法律要求或与我们的服务提供商合作的情况可能构成例外。有关您的隐私权的更多信息，请联系我们。",
        ...
        terms_of_use_text: "使用mrCetin Tech.网站即表示您同意以下使用条款。这些条款包括有关我们网站的使用、其内容、知识产权和责任限制的规定。我们网站上的内容仅供一般信息参考，不构成法律建议。您应避免滥用我们的服务、从事非法活动并尊重其他用户的权利。如果违反这些条款，您对我们服务的访问可能会受到限制或终止。请仔细阅读这些条款。",
        legal_notice_title: "法律声明",
        legal_notice_text: "本法律声明包含mrCetin Tech.的法律信息、公司详情和版权声明。我们网站上的所有内容、文本、图形、徽标和软件均由mrCetin Tech.拥有或授权，并受版权法保护。未经授权的复制、分发或使用是禁止的。我们网站上的信息是善意提供的，但不保证其准确性或完整性。如果您有任何法律问题或疑虑，请咨询合格的法律顾问。",
        sitemap_title: "网站地图",
        sitemap_text: "mrCetin Tech.网站所有页面的快速访问网站地图。包括主页、我们的应用、关于我们、愿景、使命、联系我们、隐私政策、Cookie使用、使用条款、法律声明等主要部分。此地图旨在方便您在我们网站上的导航，并帮助您更快地找到所需信息。如果任何页面链接无法正常工作，请联系我们。"
    },
    ko: {
        ...
        privacy_policy_text: "본 개인정보처리방침은 mrCetin Tech.가 귀하의 개인 데이터를 수집, 사용, 공개 및 보호하는 방법을 설명합니다. 당사 서비스를 이용함으로써 귀하는 본 정책에 설명된 관행에 동의하는 것입니다. 귀하의 데이터 보안은 당사에 중요하며, 당사는 귀하의 데이터를 보호하기 위해 필요한 모든 조치를 취합니다. 당사가 수집하는 데이터는 서비스 개선, 더 나은 경험 제공 및 법적 의무 이행을 위해 사용됩니다. 당사는 귀하의 동의 없이 제3자와 귀하의 데이터를 공유하지 않지만, 법적 요구 사항 또는 서비스 제공업체와의 협력은 예외가 될 수 있습니다. 귀하의 개인정보 보호 권리에 대한 자세한 내용은 당사에 문의하십시오.",
        ...
        legal_notice_text: "본 법적 고지에는 mrCetin Tech.의 법적 정보, 회사 세부 정보 및 저작권 진술이 포함되어 있습니다. 당사 웹사이트의 모든 콘텐츠, 텍스트, 그래픽, 로고 및 소프트웨어는 mrCetin Tech.가 소유하거나 라이선스를 받았으며 저작권법에 의해 보호됩니다. 무단 복제, 배포 또는 사용은 금지됩니다. 당사 웹사이트의 정보는 선의로 제공되지만, 정확성 또는 완전성에 대한 보증은 제공되지 않습니다. 법적 질문이나 우려 사항이 있는 경우 자격을 갖춘 법률 고문에게 문의하십시오.",
        sitemap_title: "사이트맵",
